-- ============================================================
-- 港聲 KGSH 資料庫結構（Supabase / Postgres）
...
insert into about_sections (id, emoji, title, body) values
  (1, '🌊', '關於港聲', '「港聲」是專屬小港高中學生的匿名討論區。不用再私訊 IG 等版主截圖，發文即時、留言即時、貼文可搜尋。'),
...
insert into posts (board, title, body, anon_emoji, anon_name, pinned) values
  ('notice', '🎉 港聲匿名版正式上線！',
   E'以前大家投稿都要私訊 IG 等版主截圖上傳，想找舊貼文根本大海撈針。現在有了「港聲」，發文即時、留言即時，最重要的是——終於可以搜尋了！\n\n請遵守版規、友善發言，祝大家使用愉快 🌊',
   '📣', '版主', true);
